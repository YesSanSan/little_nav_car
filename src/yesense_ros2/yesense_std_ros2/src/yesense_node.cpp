...
int g_baudrate_table[BAUDRATE_CNT] =
    {
        ...
        230400, 460800, 921600}; // 目前仅支持这些波特率

int g_baudrate_table_linux[BAUDRATE_CNT] =
    {
        B9600, B19200, B38400, B57600, B115200,
        B230400, B460800, B921600}; // 目前仅支持这些波特率
...
void YESENSE_Publisher::publish_msg(yis_out_data_t *result) {
    ...
    imu_ros_data.orientation_covariance         = {0.0025, 0, 0,
                                                   0, 0.0025, 0,
                                                   0, 0, 0.0025};
    imu_ros_data.angular_velocity_covariance    = {0.02, 0, 0,
                                                   0, 0.02, 0,
                                                   0, 0, 0.02};
    imu_ros_data.linear_acceleration_covariance = {0.04, 0, 0,
                                                   0, 0.04, 0,
                                                   0, 0, 0.04};
