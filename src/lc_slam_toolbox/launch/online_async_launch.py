...
def generate_launch_description():
    ...
    declare_autostart_cmd = DeclareLaunchArgument(
        'autostart',
        default_value='true',
        description='Automatically startup slam_toolbox. Ignored when use_lifecycle_manager is true.',
    )
    ...
    declare_slam_params_file_cmd = DeclareLaunchArgument(
        'slam_params_file',
        default_value=os.path.join(get_package_share_directory("lc_slam_toolbox"),
