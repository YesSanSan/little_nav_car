...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('lc_navigation')
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map', default_value=os.path.join(bringup_dir, 'map', 'map.yaml'), description='Full path to map yaml file to load'
    ...
    rviz_dir = os.path.join(get_package_share_directory('lc_navigation'), 'rviz', 'nav2_default_view.rviz')
    ...
    bringup_cmd_group = GroupAction(
        [
            ...
            #     package="tf2_ros",
            #     executable="static_transform_publisher",
            #     arguments=['0','0','0','0.785398','0','0','laser_link','base_link'],
            # ),
            IncludeLaunchDescription(
